...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"D:\\Front-end\\fzy-login\\.data\\kv"}));
...
const _lazy_3CJ4zG = () => import('./routes/401.mjs');
const _lazy_BRCXpQ = () => import('./routes/403.mjs');
const _lazy_pDd67q = () => import('./routes/500.mjs');
const _lazy_mAemf8 = () => import('./routes/index.mjs');
const _lazy_AJBPhu = () => import('./routes/list/_id_.delete.mjs');
const _lazy_XvKJQy = () => import('./routes/list/basic-list.post.mjs');
const _lazy_rfInXM = () => import('./routes/list/consult-list.post.mjs');
const _lazy_FvjoHd = () => import('./routes/list/create.post.mjs');
const _lazy_4pn4sz = () => import('./routes/list/crud-table.post.mjs');
const _lazy_DRglc4 = () => import('./routes/index.post.mjs');
const _lazy_5q3RAy = () => import('./routes/index.put.mjs');
const _lazy_fX6Jn9 = () => import('./routes/login.post.mjs');
const _lazy_UVyICT = () => import('./routes/logout.mjs');
const _lazy_ld6dYT = () => import('./routes/index2.mjs');
const _lazy_tOod2z = () => import('./routes/test.delete.mjs');
const _lazy_MnL90Y = () => import('./routes/test.post.mjs');
const _lazy_PnSGv1 = () => import('./routes/test.put.mjs');
const _lazy_wmsrUk = () => import('./routes/user/info.mjs');
...
export { eventHandler as e, getHeader as g, nodeServer as n, readBody as r, setResponseStatus as s };
